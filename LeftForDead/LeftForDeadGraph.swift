...
class LeftForDeadGraph: Graph {
    ...
    override init(presenter: GraphPresenter) {
        ...
        addNode(Node(id: "1.001", text: "You are at the bottom of an ocean of darkness.",
            action: DelayAction(delayInSeconds: 3, nextNodeId: "1.002")))
        
        addNode(Node(id: "1.002", text: "Down here in the dark, you see the flashes again. You can smell the smoke.",
            action: DelayAction(delayInSeconds: 4, nextNodeId: "1.003")))
        
        addNode(Node(id: "1.003", text: "You can hear the screams.",
            action: DelayAction(delayInSeconds: 3, nextNodeId: "1.2")))

        addNode(Node(id: "1.2", text: "Perhaps, though, you ought to head back to the village.",
        ...
        addNode(Node(id: "2.0", text: "Great. Let head to the river",
            action: DelayAction(delayInSeconds: 1, nextNodeId: "1.001")))
        
        addNode(Node(id: "3.0", text: "Fine. Let's go to the village then",
