...
enum Story {
    ...
    var storyText: [Sentence] {
        ...
        case .Ch1RouteA:
            return [Sentence(text: "On weary legs you trudge down the slope towards the river.", delayInSeconds: 3),
        ...
        case .Ch1RouteAA:
            return [Sentence(text: "You stand facing against the flow of the river, staying alert for more silvery flashes.", delayInSeconds: 5),
        ...
        case .Ch1RouteAAA:
            return [Sentence(text: "There are more important things to do right now than waste your time trying to achieve the impossible.", delayInSeconds: 5),
        ...
        case .Ch1RouteAAB:
            return [Sentence(text: "The minutes pass, and so do the fish, slipping easily between your hands. If only you had a net or rod of some kind.", delayInSeconds: 5),
        ...
        case .Ch1RouteAB:
            return [Sentence(text: "You turn around and climb back up the bank. There are more important things on your mind right now than eating.", delayInSeconds: 5),
        ...
        case .Ch1RouteB:
            return [Sentence(text: "You head across the grassy plaing towards the village. Fear envelops you in a web of darkness. Is it possible that anybody could be left alive?", delayInSeconds: 7),
        ...
        case .Ch1RouteBA:
            return [Sentence(text: "You wave your arms. You shout. ‘Hello!’ You call. ‘Over here! Help!’", delayInSeconds: 4),
        ...
        case .Ch1RouteBAA:
            return [Sentence(text: "You hold your hands up in a gesture of submission.", delayInSeconds: 3),
        ...
        case .Ch1RouteBAB:
            return [Sentence(text: "You turn, and you run.", delayInSeconds: 3),
        ...
        case .Ch1RouteBB:
            return [Sentence(text: "You drop to your knees and press yourself flat against the ground.", delayInSeconds: 4),
    ...
    var decisionA: DecisionButton {
        switch self{
        case .Beginning:
            return DecisionButton(text: "Head for the river", storyRoute: .Ch1RouteA)
            
        case .Ch1RouteA:
            return DecisionButton(text: "Try to catch a fish", storyRoute: .Ch1RouteAA)
            
        case .Ch1RouteAA:
            return DecisionButton(text: "Get back to the village. Now.", storyRoute: .Ch1RouteAAA)
            
        case .Ch1RouteAAA:
            return DecisionButton(text: "NO CHOICE", storyRoute: .Ch1RouteB)
        ...
        case .Ch1RouteB:
            return DecisionButton(text: "Call and wave to the rider", storyRoute: .Ch1RouteBA)
            
        case .Ch1RouteBA:
            return DecisionButton(text: "Try and plead with him", storyRoute: .Ch1RouteBAA)
            
        case .Ch1RouteBAA:
            return DecisionButton(text: "GAME OVER", storyRoute: .Beginning)
            
        case .Ch1RouteBAB:
            return DecisionButton(text: "GAME OVER", storyRoute: .Beginning)
            
        case .Ch1RouteBB:
            return DecisionButton(text: "END OF STORY", storyRoute: .Beginning)
        }
    }
    
    var decisionB: DecisionButton {
        switch self{
        case .Beginning:
            return DecisionButton(text: "Go back to the village", storyRoute: .Ch1RouteB)
            
        case .Ch1RouteA:
            return DecisionButton(text: "Head back to the village", storyRoute: .Ch1RouteAB)
            
        case .Ch1RouteAA:
            return DecisionButton(text: "Keep trying for a fish", storyRoute: .Ch1RouteAAB)
        ...
        case .Ch1RouteB:
            return DecisionButton(text: "Duck and hide in the long grass", storyRoute: .Ch1RouteBB)
            
        case .Ch1RouteBA:
            return DecisionButton(text: "Run!", storyRoute: .Ch1RouteBAB)
            
        case .Ch1RouteBAA:
            return DecisionButton(text: "RESTART", storyRoute: .Beginning)
