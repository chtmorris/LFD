...
enum Story {
    ...
    var storyText: [Sentence] {
        switch self{
        case .Beginning:
            return [Sentence(text: "You are at the bottom of an ocean of darkness.", delayInSeconds: 3, specialAttribute: "first sentence"),
            Sentence(text: "Down here in the dark, you see the flashes again. You can smell the smoke.", delayInSeconds: 4, specialAttribute: "none"),
            Sentence(text: "You can hear the screams.", delayInSeconds: 3, specialAttribute: "none"),
            Sentence(text: "The faces of the other villagers appear before you. They swim around you in the dark. Their lips are moving, but they make no sound.", delayInSeconds: 5, specialAttribute: "none"),
            ...
            Sentence(text: "You are on your back in the long grass, staring up at a sky stained with smoke. You are cold and wet, but it has never felt so good to be alive.", delayInSeconds: 6, specialAttribute: "none"),
            Sentence(text: "You sit up. The long grass has hidden you well. In the distance you see the smouldering remains of your village.", delayInSeconds: 5, specialAttribute: "none"),
            Sentence(text: "You remember running breathlessly through fields, raiders on horseback close in pursuit.", delayInSeconds: 3, specialAttribute: "none"),
            Sentence(text: "You lost your footing on the wet ground. You went down. Hit your head.", delayInSeconds: 3, specialAttribute: "none"),
            Sentence(text: "Now you touch the back of your head. It throbs.", delayInSeconds: 3, specialAttribute: "none"),
            Sentence(text: "You look at the flattened grass around you. You are sitting at the bottom of a slope.", delayInSeconds: 3, specialAttribute: "none"),
            Sentence(text: "You must slipped, knocked yourself out cold, and slithered down into this ditch.", delayInSeconds: 3, specialAttribute: "none"),
            Sentence(text: "A great thirst comes over you. Further down the slope you can hear the river where you could slake it.", delayInSeconds: 5, specialAttribute: "none"),
            Sentence(text: "Perhaps, though, you ought to head back to the village.", delayInSeconds: 3, specialAttribute: "last sentence")]
        ...
        case .Ch1RouteAA:
            return [Sentence(text: "You stand facing against the flow of the river, staying alert for more silvery flashes.", delayInSeconds: 3, specialAttribute: "none"),
                ...
                Sentence(text: "Another silver flash. Your hands go in again.", delayInSeconds: 3, specialAttribute: "none"),
                Sentence(text: "Missed.", delayInSeconds: 3, specialAttribute: "none"),
        ...
        case .Ch1RouteBAA:
            ...
            Sentence(text: "‘Please,’ you cry. ‘I’m only young.’", delayInSeconds: 3, specialAttribute: "none"),
            Sentence(text: "The Raider bears down on you.", delayInSeconds: 3, specialAttribute: "none"),
            Sentence(text: "As he reaches you, you see the burning hatred in his eyes.", delayInSeconds: 3, specialAttribute: "none"),
            Sentence(text: "It isn’t hatred. Hatred needs a cause.", delayInSeconds: 3, specialAttribute: "none"),
            Sentence(text: "The burning in his eyes is madness.", delayInSeconds: 3, specialAttribute: "none"),
            Sentence(text: "It is the burning of pure evil.", delayInSeconds: 3, specialAttribute: "none"),
            Sentence(text: "His horse pounds towards you and he raises his curved blade.", delayInSeconds: 3, specialAttribute: "none"),
            Sentence(text: "The last thing you see is the flash of steel.", delayInSeconds: 3, specialAttribute: "none"),
            Sentence(text: "GAME OVER", delayInSeconds: 3, specialAttribute: "last sentence")]
            
        case .Ch1RouteBAB:
            return [Sentence(text: "You turn, and you run.", delayInSeconds: 3, specialAttribute: "none"),
            ...
            Sentence(text: "Instead you look up at the sky, and the blood-red clouds are the last thing you see.", delayInSeconds: 3, specialAttribute: "none"),
            Sentence(text: "GAME OVER", delayInSeconds: 3, specialAttribute: "last sentence")]
        ...
        case .Ch1RouteBB:
            ...
            Sentence(text: "[Ten minute pause]", delayInSeconds: 3, specialAttribute: "none"),
